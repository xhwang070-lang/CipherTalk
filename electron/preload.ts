...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  wxKey: {
    ...
    useLocalKeys: (dbPath?: string, wxid?: string) => ipcRenderer.invoke('wxkey:useLocalKeys', dbPath, wxid),
    importLocalKeys: (filePath: string, dbPath?: string, wxid?: string) => ipcRenderer.invoke('wxkey:importLocalKeys', filePath, dbPath, wxid),
  ...
  // 图片解密（新 API）
  image: {
    decrypt: (payload: { sessionId?: string; imageMd5?: string; imageDatName?: string; createTime?: number; localId?: number; force?: boolean; quick?: boolean }) =>
